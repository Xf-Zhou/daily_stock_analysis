...
- 🔎 **股票发现** - Web 端可按市场、行业、关键词筛选股票，使用紧凑工具区、表格内滚动和 20/50/100 分页浏览可关注股票，并通过行情榜单进入分析或问股
